...
int main()
{
    ...
    {
        std::shared_ptr<MyTime> mt1 = std::make_shared<MyTime>(1, 70); // create smart pointer
        std::shared_ptr<MyTime> mt2 = mt1; // create smart pointer
        std::shared_ptr<MyTime> mt3 = mt2; // create smart pointer
